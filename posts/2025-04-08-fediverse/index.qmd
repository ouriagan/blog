...
date: "2025-04-08"
categories: [réflexion personnelles]
citation: true
lang: fr
---
...
Pour ma part, j'ai utilisé Quatro pour mettre à jour le blog que j'avais créé avec [Distill](https://pkgs.rstudio.com/distill/). Il s'agissait d'un exercice pour moi. Je suis très satisfait du rendu du blog, du moins pour l'instant. La création d'un blog avec Posit et Quatro permet de le sauvegarder sur [GitHub](https://github.com/) après création d'un compte personnel sur ce site. J'ai ensuite connecté mon compte GitHub à [Netlify](https://www.netlify.com/) qui héberge des pages web. Mon blog est alors aussitôt disponible sur internet et mis à jour à chaque modification de mon blog.

Plus récemment encore, je me suis rendu compte qu'un blog pouvait faire partie intégrante du [fediverse](https://jointhefediverse.net/?lang=fr), c'est-à-dire un réseau de serveurs (appelés *instances*) en franche rivalité avec les services centralisés tels que Facebook, X ou Instagram mus par d'importants enjeux financiers. [Mastodon](https://joinmastodon.org/) est un exemple de porte d'entrée au fediverse. J'ai au d'ailleurs créé un [compte](https://tchafia.be/@ouriagan) (\@ouriagan\@tchafia.be) qui fait office d'identité sur le fediverse. L'histoire nous dira s'il me permettra de claquer définitivement la porte à Facebook, à ses intrusions continuelles et à ses publicités. Depuis lors, j'ai l'impression d'être comme un enfant qui découvre un monde parallèle nouveau et intriguant. Il m'a amené - et m'amène encore aujourd'hui - à ma demander en quoi je pouvais y contribuer d'une manière ou d'une autre. La philosophie du réseau est d'y poster du contenu de manière libre sans l'effet dopamine des likes des réseaux commerciaux. Les messages (appelés pouets) s'y fraient un chemin de manière plus discrète et sereine, loin des remous haineux qui caractérisent ces réseaux.
