...
description: |
  Le test de Szondi est un test projectif qui se compose de deux plans : l'avant-plan (VGP) et l'arrière-plan (EKP). Sur un échantillon de 455 détenus, nous étudions les tensions obtenues aux deux plans et les corrélations entre elles. Les choix opérés à l'avant-plan et à l'arrière-plan sont positivement corrélés. Les corrélations les plus élevées concernent les facteurs s et d. Les corrélations les plus faibles concernent les facteur e, k et m.
author:
  - first_name: "Benjamin"
    last_name: "Thiry"
