...
Enfin, les réponses Textures sont positivement associées à un type de personnalité histrionique mais également aux types d’attachements sécures [@mihura2013validity]. Elles sont négativement associées à la psychopathie, aux types d’attachements évitants et à l’isolement d’un patient dans sa chambre. Cette cotation Texture bénéficie d’un bon support au niveau de la validité (*r* = .24).
