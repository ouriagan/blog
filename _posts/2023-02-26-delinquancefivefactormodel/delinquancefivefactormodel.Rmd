...
```{r delinq, echo=FALSE}
kbl(delinq, booktabs = T, caption = "Fréquences des faits de délinquance auto-révélés (au moins 1 fois) par les 112 adolescents")
```

Le tableau \@ref(tab:delinq) reprend les fréquences des faits de délinquance prétendument commis par les adolescents de notre échantillon. Les trois faits de délinquance les plus fréquents sont : le vol (47%), le vandalisme scolaire (34%) et le vandalisme public (21%).
