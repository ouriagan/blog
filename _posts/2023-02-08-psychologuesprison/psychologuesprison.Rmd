...
De manière générale, l’analyse descriptive indique, en rapport avec l’étendue des scores (de 1 à 4) que l’échantillon est relativement d’accord avec l’ensemble des propositions investiguant leur vécu institutionnel avec un degré d’accord le plus élevé concernant les aspects déontologiques et un degré d’accord le plus faible concernant le sentiment de proposer des suivis de qualité (tableau \@ref(tab:table2)). 
